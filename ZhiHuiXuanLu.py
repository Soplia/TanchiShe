...
fontPath = 'E:/VS-P/TanchiShe/simkai.ttf'
...
def Show_Start_Interface():
    title_Font = pygame.font.Font(fontPath, 100)
...
def find_snake_head(snake_Coords, direction):
    if direction == 'up':
        newHead = {'x': snake_Coords[Head_index]['x'], 'y': snake_Coords[Head_index]['y']-1}
    elif direction == 'down':
        newHead = {'x': snake_Coords[Head_index]['x'], 'y': snake_Coords[Head_index]['y']+1}
    elif direction == 'left':
        newHead = {'x': snake_Coords[Head_index]['x']-1, 'y': snake_Coords[Head_index]['y']}
...
def RunGame():
    ...
    #while True:
    #    Show_Score(score)
    #    coord = Get_Apple_Location(snake_Coords)
...
def main():
    ...
    Main_Font = pygame.font.Font(fontPath, 18)
